    ...
    var body: some View {
        Menu {
            ...
            Section("Global") {
                ...
                sourceButton(.dynamicWorld(year: 2023), label: "Esri Land Cover (10m)", icon: "globe")
            ...
            Section("Europe — Crop Type") {
                sourceButton(.turkeyCorine(year: 2018), label: "\u{1F1EA}\u{1F1FA} CORINE Land Cover", icon: "leaf.fill")
